...
import tech.neyrox.event.impl.EventAttack;
...
public class BotController {
   ...
   public final Object2ObjectLinkedOpenHashMap<Pair<BlockPos, CPlayerDiggingPacket.Action>, Vector3d> unacknowledgedDiggingPackets;
   ...
   public void acknowledgePlayerDiggingReceived(BotWorld worldIn, BlockPos pos, BlockState blockIn, CPlayerDiggingPacket.Action action, boolean successful) {
      ...
      while(this.unacknowledgedDiggingPackets.size() >= 50) {
         Pair<BlockPos, CPlayerDiggingPacket.Action> pair = (Pair)this.unacknowledgedDiggingPackets.firstKey();
