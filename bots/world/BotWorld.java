...
import bots.player.BotControllerOF;
...
public class BotWorld extends ClientWorld {
   private static final ThreadLocal<BotClientPlayNetHandler> CONSTRUCTING_CONNECTION = new ThreadLocal();
   ...
   protected final Object2ObjectArrayMap<ColorResolver, ColorCache> colorCaches = (Object2ObjectArrayMap)Util.make(new Object2ObjectArrayMap(3), (p_lambda$new$0_0_) -> {
   ...
   public static BotWorld create(BotClientPlayNetHandler p_i242067_1_, ClientWorld.ClientWorldInfo p_i242067_2_, RegistryKey<World> p_i242067_3_, DimensionType p_i242067_4_, int p_i242067_5_, Supplier<IProfiler> p_i242067_6_, WorldRenderer p_i242067_7_, boolean p_i242067_8_, long p_i242067_9_) {
      CONSTRUCTING_CONNECTION.set(p_i242067_1_);

      try {
         return new BotWorld(p_i242067_1_, p_i242067_2_, p_i242067_3_, p_i242067_4_, p_i242067_5_, p_i242067_6_, p_i242067_7_, p_i242067_8_, p_i242067_9_);
      } finally {
         CONSTRUCTING_CONNECTION.remove();
      }
   }

   public BotWorld(BotClientPlayNetHandler p_i242067_1_, ClientWorld.ClientWorldInfo p_i242067_2_, RegistryKey<World> p_i242067_3_, DimensionType p_i242067_4_, int p_i242067_5_, Supplier<IProfiler> p_i242067_6_, WorldRenderer p_i242067_7_, boolean p_i242067_8_, long p_i242067_9_) {
      super((net.minecraft.client.network.play.ClientPlayNetHandler)null, p_i242067_2_, p_i242067_3_, p_i242067_4_, p_i242067_5_, p_i242067_6_, p_i242067_7_, p_i242067_8_, p_i242067_9_);
      ...
      if (this.connection.botController != null && this.connection.botController.getClass() == BotController.class) {
         this.connection.botController = new BotControllerOF(this.mc, this.connection);
      }
   ...
   public void onChunkUnloaded(Chunk chunkIn) {
      ...
      ((Collection)collection).addAll(chunkIn.getTileEntityMap().values());
      this.getChunkProvider().getLightManager().enableLightSources(chunkIn.getPos(), false);
   }
      ...
      if (entityIn.func_233578_ci_()) {
         ...
         if (!entityIn.addedToChunk || entityIn.chunkCoordX != i || entityIn.chunkCoordY != j || entityIn.chunkCoordZ != k) {
            ...
            if (!entityIn.func_233577_ch_() && !this.chunkExists(i, k)) {
               if (entityIn.addedToChunk) {
                  LOGGER.warn("Entity {} left loaded chunk area", entityIn);
               }
   ...
   public void removeEntityFromWorld(int eid) {
      Entity entity = (Entity)this.entitiesById.remove(eid);
      if (entity != null) {
         entity.remove();
         this.removeEntity(entity);
      }
   ...
   public void sendQuittingDisconnectingPacket() {
      this.connection.getBotNetwork().closeChannel(new TranslationTextComponent("multiplayer.status.quitting"));
   }
   ...
   public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ, @Nullable CompoundNBT compound) {
      this.mc.particles.addEffect(new FireworkParticle.Starter((ClientWorld)this, x, y, z, motionX, motionY, motionZ, this.mc.particles, compound));
   }
   ...
   // getChunkProvider inherited from ClientWorld
   ...
   public MapData getMapData(String mapName) {
      return (MapData)this.maps.get(mapName);
   }
   ...
   public ITagCollectionSupplier getTags() {
      BotClientPlayNetHandler connection = this.connection != null ? this.connection : (BotClientPlayNetHandler)CONSTRUCTING_CONNECTION.get();
      return connection != null ? connection.getTags() : ITagCollectionSupplier.TAG_COLLECTION_SUPPLIER;
   }

   public DynamicRegistries func_241828_r() {
      BotClientPlayNetHandler connection = this.connection != null ? this.connection : (BotClientPlayNetHandler)CONSTRUCTING_CONNECTION.get();
      return connection != null ? connection.func_239165_n_() : DynamicRegistries.func_239770_b_();
   }
   ...
   public void playEvent(@Nullable PlayerEntity player, int type, BlockPos pos, int data) {
      try {
         ...
         crashreportcategory.addDetail("Block coordinates", (Object)CrashReportCategory.getCoordinateInfo(pos));
         crashreportcategory.addDetail("Event source", (Object)player);
         crashreportcategory.addDetail("Event type", (Object)type);
         crashreportcategory.addDetail("Event data", (Object)data);
   ...
   public Biome getNoiseBiomeRaw(int x, int y, int z) {
      return (Biome)this.func_241828_r().getRegistry(Registry.BIOME_KEY).getOrThrow(Biomes.PLAINS);
   }
   ...
   public Vector3d getSkyColor(BlockPos blockPosIn, float partialTicks) {
      ...
      if (this.timeLightningFlash > 0) {
         f11 = (float)this.timeLightningFlash - partialTicks;
         if (f11 > 1.0F) {
            f11 = 1.0F;
         }
   ...
   public int getBlockColor(BlockPos blockPosIn, ColorResolver colorResolverIn) {
      ColorCache colorcache = (ColorCache)this.colorCaches.get(colorResolverIn);
   ...
   public ClientWorld.ClientWorldInfo getWorldInfo() {
      return this.field_239130_d_ != null ? this.field_239130_d_ : super.getWorldInfo();
   }
