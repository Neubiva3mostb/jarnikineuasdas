...
import bots.impl.BotClientSuggestionProvider;
...
import tech.neyrox.Neyrox;
import tech.neyrox.event.impl.EventPickupItem;
import tech.neyrox.modules.impl.movement.FreeCum;
import tech.neyrox.modules.impl.pve.Bots;
import tech.neyrox.modules.impl.visual.HUD;
import tech.neyrox.ui.hud.impl.Notifications;

public class BotClientPlayNetHandler implements IClientPlayNetHandler {
   public static final Logger LOGGER = LogManager.getLogger();
   public static final ITextComponent field_243491_b = new TranslationTextComponent("disconnect.lost");
   public final BotNetwork netManager;
   public final GameProfile profile;
   public final Screen guiScreenServer;
   public Minecraft client;
   public BotWorld world;
   public ClientWorld.ClientWorldInfo field_239161_g_;
   public boolean doneLoadingTerrain;
   public final Map<UUID, NetworkPlayerInfo> playerInfoMap = Maps.newHashMap();
   public final ClientAdvancementManager advancementManager;
   public final BotClientSuggestionProvider clientSuggestionProvider;
   public ITagCollectionSupplier networkTagManager;
   public int viewDistance;
   public final Random avRandomizer;
   public CommandDispatcher<ISuggestionProvider> commandDispatcher;
   public final RecipeManager recipeManager;
   public final UUID sessionId;
   public Set<RegistryKey<World>> field_239162_s_;
   public DynamicRegistries field_239163_t_;
   public BotPlayer bot;
   public BotController botController;
   public Bot realBot;

   public BotClientPlayNetHandler(Minecraft mcIn, Screen previousGuiScreen, BotNetwork networkManagerIn, GameProfile profileIn) {
      this.networkTagManager = ITagCollectionSupplier.TAG_COLLECTION_SUPPLIER;
      this.viewDistance = 3;
      this.avRandomizer = new Random();
      this.commandDispatcher = new CommandDispatcher();
      this.recipeManager = new RecipeManager();
      this.sessionId = UUID.randomUUID();
      this.field_239163_t_ = DynamicRegistries.func_239770_b_();
      this.client = mcIn;
      this.guiScreenServer = previousGuiScreen;
      this.netManager = networkManagerIn;
      this.profile = profileIn;
      this.advancementManager = new ClientAdvancementManager(mcIn);
      this.clientSuggestionProvider = new BotClientSuggestionProvider(this, mcIn);
   }

   public BotClientSuggestionProvider getSuggestionProvider() {
   ...
   public void handleJoinGame(SJoinGamePacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      BotManager.xyesosBots.add(new Bot((BotNetwork)null, (BotWorld)null, (BotPlayer)null, (BotController)null, this));
      ...
      int var10007 = this.viewDistance;
      Minecraft var10008 = this.client;
      Objects.requireNonNull(var10008);
      this.world = BotWorld.create(this, clientworld$clientworldinfo, registrykey, dimensiontype, var10007, var10008::getProfiler, this.client.worldRenderer, flag, packetIn.getHashedSeed());
      if (this.bot == null) {
         this.botController = new BotController(this.client, this);
         this.bot = this.botController.createPlayer(this.world, new StatisticsManager(), new ClientRecipeBook());
         this.botController.bot = this.bot;
         this.bot.rotationYaw = -180.0F;
         if (this.client.getIntegratedServer() != null) {
            this.client.getIntegratedServer().setPlayerUuid(this.bot.getUniqueID());
         }
      }
      ...
      this.world.addPlayer(i, this.bot);
      this.bot.movementInput = new MovementInputFromOptions(this.client.gameSettings);
      this.botController.setPlayerCapabilities(this.bot);
      this.bot.setEntityId(i);
      this.bot.setReducedDebug(packetIn.isReducedDebugInfo());
      this.bot.setShowDeathScreen(packetIn.func_229743_k_());
      this.botController.func_241675_a_(packetIn.func_241786_f_());
      BotManager.pendingNetworks.remove(this.netManager);
      if (BotManager.allBots.stream().noneMatch((bot1) -> {
         return bot1.connection == this;
      })) {
         Bot bot = new Bot(this.netManager, this.world, this.bot, this.botController, this);
      ...
      // startGameBotSession() is not available; ensure any required init occurs elsewhere
   }
   ...
   public void handleSpawnObject(SSpawnObjectPacket packetIn) {
      ...
      if (entitytype == EntityType.CHEST_MINECART) {
         ...
         if (entitytype == EntityType.FISHING_BOBBER) {
            entity4 = this.world.getEntityByID(packetIn.getData());
      ...
      if (entity != null) {
         ...
         ((Entity)entity).setPacketCoordinates(d0, d1, d2);
         ((Entity)entity).moveForced(d0, d1, d2);
   ...
   public void handleSpawnPlayer(SSpawnPlayerPacket packetIn) {
      ...
      int i = packetIn.getEntityID();
      NetworkPlayerInfo networkplayerinfo = this.getPlayerInfo(packetIn.getUniqueId());
      GameProfile gameprofile = networkplayerinfo != null ? networkplayerinfo.getGameProfile() : new GameProfile(packetIn.getUniqueId(), packetIn.getUniqueId().toString());
      if (networkplayerinfo == null) {
         LOGGER.warn("Missing player info for spawned player {}, using fallback profile", packetIn.getUniqueId());
      }

      RemoteClientPlayerEntity remoteclientplayerentity = new RemoteClientPlayerEntity(this.world, gameprofile);
   ...
   public void handleEntityMovement(SEntityPacket packetIn) {
      ...
      if (entity != null && !entity.canPassengerSteer()) {
         ...
         if (packetIn.func_229745_h_()) {
            ...
            f3 = packetIn.isRotating() ? (float)(packetIn.getYaw() * 360) / 256.0F : entity.rotationYaw;
            float f1 = packetIn.isRotating() ? (float)(packetIn.getPitch() * 360) / 256.0F : entity.rotationPitch;
            entity.setPositionAndRotationDirect(vector3d.getX(), vector3d.getY(), vector3d.getZ(), f3, f1, 3, false);
         } else if (packetIn.isRotating()) {
            float f2 = (float)(packetIn.getYaw() * 360) / 256.0F;
            f3 = (float)(packetIn.getPitch() * 360) / 256.0F;
   ...
   public void handlePlayerPosLook(SPlayerPositionLookPacket packetIn) {
      ...
      if (!((FreeCum)Neyrox.getInstance().moduleManager.find(FreeCum.class)).isEnabled()) {
   ...
   public void handleChunkData(SChunkDataPacket packetIn) {
      ...
      Iterator var10 = packetIn.getTileEntityTags().iterator();

      while(var10.hasNext()) {
         CompoundNBT compoundnbt = (CompoundNBT)var10.next();
   ...
   public void onDisconnect(ITextComponent reason) {
      LOGGER.warn("Bot disconnected: {}", reason.getString());
      if (this.client.renderViewEntity == this.bot) {
         this.client.renderViewEntity = this.client.player;
         if (this.client.world != null) {
            this.client.loadWorld(this.client.world);
         }
      }
      BotManager.allBots.removeIf((bot) -> {
         return bot.connection == this;
      });
      BotManager.xyesosBots.removeIf((bot) -> {
         return bot.connection == this;
      });
      BotManager.tapeMouseBots.removeIf((tapeBot) -> {
         return tapeBot.getBot().connection == this;
      });
      BotManager.pendingNetworks.remove(this.netManager);
      this.cleanup();
      this.client.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((new StringTextComponent("Бота кикнуло по причине: ")).append(reason), 0);
   }
   ...
   public void handleCollectItem(SCollectItemPacket packetIn) {
      ...
      if (entity != null) {
         ...
         this.client.particles.addEffect(new ItemPickupParticle(this.client.getRenderManager(), this.client.getRenderTypeBuffers(), this.world, entity, (Entity)livingentity));
         if (entity instanceof ItemEntity) {
            ItemEntity itementity = (ItemEntity)entity;
            ItemStack itemstack = itementity.getItem();
            (new EventPickupItem(itemstack, (LivingEntity)livingentity, itementity)).call();
            itemstack.shrink(packetIn.getAmount());
            if (itemstack.isEmpty()) {
               if (!itemstack.getDisplayName().getSiblings().isEmpty() && livingentity == this.bot) {
                  ((HUD)Neyrox.getInstance().moduleManager.find(HUD.class)).notifications.infoNotifications.add(new Notifications.InfoNotification(itemstack.getDisplayName()));
               }
   ...
   public void handleChat(SChatPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      if (((Bots)Neyrox.getInstance().moduleManager.find(Bots.class)).visible.isEnabled("Чат")) {
   ...
   public void handleSpawnMob(SSpawnMobPacket packetIn) {
      ...
      float f = (float)(packetIn.getYaw() * 360) / 256.0F;
      float f1 = (float)(packetIn.getPitch() * 360) / 256.0F;
      LivingEntity livingentity = (LivingEntity)EntityType.create(packetIn.getEntityType(), this.world);
      if (livingentity != null) {
         ...
         if (livingentity instanceof BeeEntity) {
            ...
            this.client.getSoundHandler().playOnNextTick((ITickableSound)beesound);
         }
      } else {
   ...
   public void handleTimeUpdate(SUpdateTimePacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      this.world.func_239134_a_(packetIn.getTotalWorldTime());
      this.world.setDayTime(packetIn.getWorldTime());
   }

   public void func_230488_a_(SWorldSpawnChangedPacket p_230488_1_) {
      PacketThreadUtil.checkThreadAndEnqueue(p_230488_1_, this, (ThreadTaskExecutor)this.client);
      this.world.func_239136_a_(p_230488_1_.func_240832_b_(), p_230488_1_.func_244313_c());
   }
   ...
   public void handleSetPassengers(SSetPassengersPacket packetIn) {
      ...
      if (entity == null) {
         ...
         boolean flag = entity.isRidingOrBeingRiddenBy(this.bot);
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (entity1 != null) {
               ...
               if (entity1 == this.bot && !flag) {
                  this.client.ingameGUI.setOverlayMessage(new TranslationTextComponent("mount.onboard", new Object[]{this.client.gameSettings.keyBindSneak.func_238171_j_()}), false);
               }
            }
         }
      }
   ...
   public void handleEntityStatus(SEntityStatusPacket packetIn) {
      ...
      if (entity != null) {
         if (packetIn.getOpCode() == 21) {
            ...
            if (entity == this.bot) {
               this.client.gameRenderer.displayItemActivation(getTotemItem(this.bot));
            }
         } else {
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      ...
      boolean controllingThisBot = this.client.renderViewEntity == clientplayerentity;
      ...
      if (registrykey != clientplayerentity.world.getDimensionKey()) {
         ...
         Difficulty difficulty = this.field_239161_g_ != null ? this.field_239161_g_.getDifficulty() : Difficulty.NORMAL;
         boolean hardcore = this.field_239161_g_ != null && this.field_239161_g_.isHardcore();
         ClientWorld.ClientWorldInfo clientworld$clientworldinfo = new ClientWorld.ClientWorldInfo(difficulty, hardcore, flag1);
         this.field_239161_g_ = clientworld$clientworldinfo;
         int var10007 = this.viewDistance;
         Minecraft var10008 = this.client;
         Objects.requireNonNull(var10008);
      ...
      BotPlayer clientplayerentity1 = this.botController.func_239167_a_(this.world, clientplayerentity.getStats(), clientplayerentity.getRecipeBook(), clientplayerentity.isSneaking(), clientplayerentity.isSprinting());
      clientplayerentity1.setEntityId(i);
      this.bot = clientplayerentity1;
      this.botController.bot = this.bot;
      if (registrykey != clientplayerentity.world.getDimensionKey()) {
      ...
      if (controllingThisBot) {
         this.client.renderViewEntity = this.bot;
      }
      ...
      this.botController.setPlayerCapabilities(clientplayerentity1);
      ...
      this.botController.func_241675_a_(packetIn.func_241788_f_());
   }

   public void handleExplosion(SExplosionPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      Explosion explosion = new Explosion(this.world, (Entity)null, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getStrength(), packetIn.getAffectedBlockPositions());
      explosion.doExplosionB(true);
      this.bot.setMotion(this.bot.getMotion().add((double)packetIn.getMotionX(), (double)packetIn.getMotionY(), (double)packetIn.getMotionZ()));
   }
   ...
   public void handleOpenWindowPacket(SOpenWindowPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      ScreenManager.openScreenToBot(packetIn.getContainerType(), this.client, packetIn.getWindowId(), packetIn.getTitle(), this.realBot);
   }
   ...
   public void handleSignEditorOpen(SOpenSignMenuPacket packetIn) {
      ...
      if (!(tileentity instanceof SignTileEntity)) {
         ...
         ((TileEntity)tileentity).setWorldAndPos(this.world, packetIn.getSignPosition());
      }

      this.bot.openSignEditor((SignTileEntity)tileentity);
   }
   ...
   public void handleUpdateTileEntity(SUpdateTileEntityPacket packetIn) {
      ...
      if (i == 1 && tileentity instanceof MobSpawnerTileEntity || flag || i == 3 && tileentity instanceof BeaconTileEntity || i == 4 && tileentity instanceof SkullTileEntity || i == 6 && tileentity instanceof BannerTileEntity || i == 7 && tileentity instanceof StructureBlockTileEntity || i == 8 && tileentity instanceof EndGatewayTileEntity || i == 9 && tileentity instanceof SignTileEntity || i == 11 && tileentity instanceof BedTileEntity || i == 5 && tileentity instanceof ConduitTileEntity || i == 12 && tileentity instanceof JigsawTileEntity || i == 13 && tileentity instanceof CampfireTileEntity || i == 14 && tileentity instanceof BeehiveTileEntity) {
         tileentity.read(this.world.getBlockState(blockpos), packetIn.getNbtCompound());
      }
   ...
   public void handleEntityEquipment(SEntityEquipmentPacket packetIn) {
      ...
      if (entity != null) {
         packetIn.func_241790_c_().forEach((p_241664_1_) -> {
            entity.setItemStackToSlot((EquipmentSlotType)p_241664_1_.getFirst(), (ItemStack)p_241664_1_.getSecond());
         });
      }
   ...
   public void handleChangeGameState(SChangeGameStatePacket packetIn) {
      ...
      if (schangegamestatepacket$state == SChangeGameStatePacket.field_241764_a_) {
         ...
         this.botController.setGameType(GameType.getByID(i));
      } else if (schangegamestatepacket$state == SChangeGameStatePacket.field_241768_e_) {
         if (i == 0) {
            this.bot.connection.sendPacket(new CClientStatusPacket(CClientStatusPacket.State.PERFORM_RESPAWN));
         } else if (i == 1) {
         ...
         if (f == 0.0F) {
            ...
            this.client.ingameGUI.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.movement", new Object[]{gamesettings.keyBindForward.func_238171_j_(), gamesettings.keyBindLeft.func_238171_j_(), gamesettings.keyBindBack.func_238171_j_(), gamesettings.keyBindRight.func_238171_j_()}));
         } else if (f == 102.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.jump", new Object[]{gamesettings.keyBindJump.func_238171_j_()}));
         } else if (f == 103.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.inventory", new Object[]{gamesettings.keyBindInventory.func_238171_j_()}));
         } else if (f == 104.0F) {
            this.client.ingameGUI.getChatGUI().printChatMessage(new TranslationTextComponent("demo.day.6", new Object[]{gamesettings.keyBindScreenshot.func_238171_j_()}));
         }
         ...
         this.bot.setShowDeathScreen(f == 0.0F);
      }
   ...
   public void handleMaps(SMapDataPacket packetIn) {
      ...
      MapData mapdata = this.world.getMapData(s);
      if (mapdata == null) {
         ...
         this.world.registerMapData(mapdata);
      }
   ...
   public void handleUpdateRecipes(SUpdateRecipesPacket packetIn) {
      ...
      ClientRecipeBook clientrecipebook = this.bot.getRecipeBook();
      clientrecipebook.func_243196_a(this.recipeManager.getRecipes());
      List<RecipeList> var10000 = clientrecipebook.getRecipes();
      Objects.requireNonNull(imutablesearchtree);
      var10000.forEach((RecipeList rl) -> imutablesearchtree.func_217872_a(rl));
   ...
   public void handlePlayerLook(SPlayerLookPacket packetIn) {
      ...
      if (vector3d != null) {
         this.bot.lookAt(packetIn.getSourceAnchor(), vector3d);
      }
   ...
   public void handleStatistics(SStatisticsPacket packetIn) {
      ...
      while(var2.hasNext()) {
         ...
         this.bot.getStats().setValue(this.bot, stat, i);
      }
   ...
   public void handleRecipeBook(SRecipeBookPacket packetIn) {
      ...
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      clientrecipebook = this.bot.getRecipeBook();
      ...
      case REMOVE:
         var4 = packetIn.getRecipes().iterator();
         ...
         while(true) {
            ...
            var10000 = this.recipeManager.getRecipe(resourcelocation2);
            Objects.requireNonNull(clientrecipebook);
            var10000.ifPresent((Object r) -> {
               if (r instanceof IRecipe<?>) clientrecipebook.lock((IRecipe<?>)r);
            });
         }
      case INIT:
         var4 = packetIn.getRecipes().iterator();
         ...
         while(var4.hasNext()) {
            ...
            Objects.requireNonNull(clientrecipebook);
            var10000.ifPresent((Object r) -> {
               if (r instanceof IRecipe<?>) clientrecipebook.unlock((IRecipe<?>)r);
            });
         }

         var4 = packetIn.getDisplayedRecipes().iterator();
         ...
         while(true) {
            ...
            Objects.requireNonNull(clientrecipebook);
            var10000.ifPresent((Object r) -> {
               if (r instanceof IRecipe<?>) clientrecipebook.markNew((IRecipe<?>)r);
            });
         }
      case ADD:
         var4 = packetIn.getRecipes().iterator();
         ...
         while(var4.hasNext()) {
            resourcelocation2 = (ResourceLocation)var4.next();
            this.recipeManager.getRecipe(resourcelocation2).ifPresent((p_217278_2_) -> {
   ...
   public void handleServerDifficulty(SServerDifficultyPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      if (this.field_239161_g_ == null) {
         LOGGER.warn("Received bot difficulty packet before world info initialization");
         return;
      }
   ...
   public void handleSoundEffect(SPlaySoundEffectPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      this.world.playSound(this.bot, packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getSound(), packetIn.getCategory(), packetIn.getVolume(), packetIn.getPitch());
   }
   ...
   public void handleSpawnMovingSoundEffect(SSpawnMovingSoundEffectPacket packetIn) {
      ...
      if (entity != null) {
         this.world.playMovingSound(this.bot, entity, packetIn.func_218763_b(), packetIn.func_218760_c(), packetIn.func_218764_e(), packetIn.func_218761_f());
      }
   ...
   public void handleUpdateBossInfo(SUpdateBossInfoPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      if (((Bots)Neyrox.getInstance().moduleManager.find(Bots.class)).visible.isEnabled("БоссБар")) {
   ...
   public void handleOpenBookPacket(SOpenBookWindowPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      ItemStack itemstack = this.bot.getHeldItem(packetIn.getHand());
   ...
   public void handleCustomPayload(SCustomPayloadPlayPacket packetIn) {
      ...
      try {
         ...
         if (SCustomPayloadPlayPacket.BRAND.equals(resourcelocation)) {
            this.bot.setServerBrand(packetbuffer.readString(32767));
         } else {
            int j2;
            if (SCustomPayloadPlayPacket.DEBUG_PATH.equals(resourcelocation)) {
               ...
               if (SCustomPayloadPlayPacket.DEBUG_CAVES.equals(resourcelocation)) {
                  blockpos8 = packetbuffer.readBlockPos();
                  ...
                  this.client.debugRenderer.cave.addCave(blockpos8, list1, list3);
               } else {
                  int j6;
                  int j5;
                  if (SCustomPayloadPlayPacket.DEBUG_STRUCTURES.equals(resourcelocation)) {
                     DimensionType dimensiontype = (DimensionType)this.field_239163_t_.func_230520_a_().getOrDefault(packetbuffer.readResourceLocation());
                     ...
                     if (SCustomPayloadPlayPacket.DEBUG_POI_ADDED.equals(resourcelocation)) {
                        ...
                        j5 = packetbuffer.readInt();
                        PointOfInterestDebugRenderer.POIInfo pointofinterestdebugrenderer$poiinfo = new PointOfInterestDebugRenderer.POIInfo(blockpos8, s9, j5);
                        ...
                        blockpos8 = packetbuffer.readBlockPos();
                        this.client.debugRenderer.field_239371_m_.func_217698_a(blockpos8);
                     } else if (SCustomPayloadPlayPacket.DEBUG_POI_TICKET_COUNT.equals(resourcelocation)) {
                        blockpos8 = packetbuffer.readBlockPos();
                        l3 = packetbuffer.readInt();
                        this.client.debugRenderer.field_239371_m_.func_217706_a(blockpos8, l3);
                        ...
                        for(i6 = 0; i6 < j5; ++i6) {
                           ...
                           list3.add(new EntityAIDebugRenderer.Entry(blockpos8, j6, s, flag));
                        }
                        ...
                        if (SCustomPayloadPlayPacket.DEBUG_BRAIN.equals(resourcelocation)) {
                           ...
                           PointOfInterestDebugRenderer.BrainInfo pointofinterestdebugrenderer$braininfo = new PointOfInterestDebugRenderer.BrainInfo(uuid1, k6, s1, s2, i1, f1, f2, iposition1, s3, path1, flag2);
                           ...
                           if (SCustomPayloadPlayPacket.field_229728_n_.equals(resourcelocation)) {
                              ...
                              BeeDebugRenderer.Hive beedebugrenderer$hive = new BeeDebugRenderer.Hive(blockpos8, s9, j5, l5, flag3, this.world.getGameTime());
   ...
   public void handlePlaceGhostRecipe(SPlaceGhostRecipePacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      Container container = this.bot.openContainer;
      if (container.windowId == packetIn.getWindowId() && container.getCanCraft(this.bot)) {
   ...
   public void handleAcknowledgePlayerDigging(SPlayerDiggingPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, (ThreadTaskExecutor)this.client);
      this.botController.acknowledgePlayerDiggingReceived(this.world, packetIn.getPosition(), packetIn.getBlockState(), packetIn.getAction(), packetIn.wasSuccessful());
   }
   ...
   private void setLightData(int chunkX, int chunkZ, WorldLightManager lightManager, LightType type, int p_217284_5_, int p_217284_6_, Iterator<byte[]> p_217284_7_, boolean p_217284_8_) {
      for(int i = 0; i < 18; ++i) {
         ...
         if (flag || flag1) {
            lightManager.setData(type, SectionPos.of(chunkX, j, chunkZ), flag ? new NibbleArray((byte[])((byte[])p_217284_7_.next()).clone()) : new NibbleArray(), p_217284_8_);
